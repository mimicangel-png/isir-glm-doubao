...
# 已清仓: 汇通能源600605(9/23@31, +18.8%)/富祥股份平安仓19900股(9/23@20.15, +5.4%, 国金仓仍持有)
#         东田微301183(9/16@284)/生益电子688183(9/15@126.25)/国际复材(9/15@32.05)/沃森生物(9/11止损)/蓝色光标/三变科技/奥飞数据/龙蟠科技
# 港股: 资玩6400股(HK$9.68, 引擎不支持不入池)
# 注: 9/21四张截图两两拼合(平安2张+国金2张,中段重叠)已确认为完整持仓, 无缺失个股
HOLDINGS = [
    "600089",  # 特变电工 18200股(国金) 成本12.277 +49.06%
    "300497",  # 富祥股份 12200股(国金) 成本18.581 ｜平安仓19900@19.112已于9/23@20.15清仓(+5.4%)
    ...
    # 汇通能源600605 9900股(平安) 已于9/23@31全部清仓(+18.8%, 兑现约¥48,609) → 转入focus清仓追踪
