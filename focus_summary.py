...
FOCUS = {
    ...
    "300497": ("富祥股份", "持仓/医药中间体CDMO"),
    "600605": ("汇通能源", "持仓/风电运营(新买)"),
    "601208": ("东材科技", "持仓/新材料(补仓摊成本63.9)"),
    "603389": ("亚振家居", "持仓/家居(深套-48%/-23%)"),
    "300666": ("江丰电子", "持仓/半导体靶材(新买)"),
    "002149": ("西部材料", "持仓/钛材(深套-54%)"),
    "002222": ("福晶科技", "持仓/激光晶体(深套-62%/-19%)"),
    "300346": ("南大光电", "持仓/光刻胶"),
    "300570": ("太辰光", "持仓/光模块连接(新买)"),
    "600226": ("亨通股份", "持仓/光纤"),
    "301358": ("湖南裕能", "持仓/锂电正极(深套-37%)"),
    "002463": ("沪电股份", "持仓/AI-PCB(新买)"),
    "601869": ("长飞光纤", "持仓/光纤(新买)"),
    "603650": ("彤程新材", "持仓/光刻胶(9/17买)"),
    "002927": ("泰永长征", "持仓/低压电器"),
