...
FOCUS = {
    ...
    # ===== 清仓待操作池 (2026-09-23用户指定: 所有清仓股都需持续操作/可再买入, 非被动追踪) =====
    "600605": ("汇通能源", "清仓待操作(9/23@31卖出, 成本26.090 +18.8%)"),
    "301183": ("东田微", "清仓待操作(9/16@284卖出, 成本275.4)"),
    "688183": ("生益电子", "清仓待操作(9/15@126.25卖出)"),
    "301526": ("国际复材", "清仓待操作(9/15@32.05卖出)"),
    "300142": ("沃森生物", "清仓待操作(9/11止损卖出)"),
    "300058": ("蓝色光标", "清仓待操作(9/15前已清)"),
    "002112": ("三变科技", "清仓待操作(9/15前已清)"),
    "300738": ("奥飞数据", "清仓待操作(9/15前已清)"),
    "603906": ("龙蟠科技", "清仓待操作(已清,2026-09-23补入底池)"),
    # ===== 重点关注(非持仓) =====
    "300308": ("中际旭创", "光模块"),
    "002851": ("麦格米特", "电力电子"),
    "301122": ("采纳股份", "医疗器械"),
